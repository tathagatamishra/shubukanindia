...
export const blogPosts = [
  {
    ...
    // authors: [
    //   {
    //     name: "Sensei Tathagata Mishra",
    //     title: "Karate Instructor",
    //     biography:
    //       "Sensei Mishra has dedicated years to studying traditional Karate and modern training methods, specializing in striking techniques and martial conditioning.",
    //     avatarImage:
        ...
        contentBlocks: [
          {
            type: "quote",
            order: 1,
            text: "A punch should be like an arrow — straight, precise, and unstoppable.",
            caption: "Karate proverb",
          },
        ],
      },
    ],
